...
export default function EmptyViewportOverlay({ availableSeries, onSelect }: EmptyViewportOverlayProps) {
  // Filter out scouts
    ...
    <div className="absolute inset-0 z-20 flex items-center justify-center bg-neutral-900/90">
      <div className="w-56 max-h-[80%] overflow-y-auto rounded-lg bg-neutral-800 border border-neutral-700 shadow-xl">
        <div className="px-3 py-2 border-b border-neutral-700">
          <span className="text-xs font-medium text-neutral-300">Load series</span>
        </div>
        <div className="py-1">
          {clinical.map((s) => {
